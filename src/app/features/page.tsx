    ...
    <div className="bg-background min-h-screen p-4 sm:p-8">
        <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center">
                <h1 className="text-4xl font-headline font-bold tracking-tight text-primary">TTR Gestion</h1>
                <p className="mt-2 text-lg text-muted-foreground">La meilleure application de gestion simplifiée, assistée par IA.</p>
                <p className="mt-4 max-w-2xl mx-auto">Nous mettons un outil très puissant à votre disposition pour sécuriser et développer votre business à un prix ultra accessible.</p>
            ...
            <Card className="shadow-lg">
                ...
                <CardDescription>
                    Un écosystème complet pour piloter votre entreprise vers le succès.
                </CardDescription>
                </CardHeader>
